...
$jobs = [
    [
        'name' => 'Хозяйка нескольких людей',
        'date_start' => 'Jan 2020',
        'date_end' => 'Current',
        'description' => 'Управляю людьми, слежу чтобы они не баловали, не ленились и слишком не веселились )',
    ],
    [
        'name' => 'Несущий хаос в человеческие жизни котенок',
        'date_start' => 'Jan 2019',
        'date_end' => 'Jan 2020',
        'description' => 'Обучалась и получала первый опыт знакомства с двуногими, оттачивала навыки влияния и управления',
    ],
    [
        'name' => 'Новорожденный детеныш в подворотне',
        'date_start' => 'Dec 2018',
        'date_end' => 'Jan 2019',
        'description' => 'Следила и искала жертву среди двуногих',
    ],
];
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            ...
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $jobs[$i]["date_start"];?> - <span
                class="w3-tag w3-teal w3-round"><?php echo $jobs[$i]["date_end"];?></span></h6>
