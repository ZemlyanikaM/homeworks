...
def clients_sorted_products(request, id_client: int, days: int):
    ...
    return render(request, 'hw4app/clients_sorted_products.html',
...
def client_orders(request, id_client: int):
    ...
    return render(request, 'hw4app/client_orders.html', {'client': client, 'orders': orders, 'products': products})
...
def product(request, id_pr: int):
    ...
    return render(request, "hw4app/product.html", context=context)
...
def edit_product(request):
    ...
    return render(request, "hw4app/edit_product_form.html", context=context)
...
def product_form(request, id_pr: int):
    ...
    return render(request, "hw4app/product_form.html", context=context)
